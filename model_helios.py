...
import numpy as np
from helpers import fetch_api_data, fetch_wingobot_daily_history, get_current_period_1min, get_oss_data_status, load_daily_1k_history, normalize_side, verified_outcome
...
def _skeleton_payload():
    ...
    return {
        ...
        'predictionDetails': {'gameType': 'Wingo 1 Min Helios', 'confidence': confidence, 'actual': actual, 'number': number},
